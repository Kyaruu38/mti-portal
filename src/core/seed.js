...
export function seedIfEmpty() {
  ...
  const suppliers = [
    ...
    { id: uid('sup'), name: 'CV LANCAR JAYA PACKINDO', city: 'Kendal', address: 'Jl. Raya Kaliwungu KM 19, Kendal', contact: 'Agus Salim', phone: '+62 815-7622-018', bank: 'BCA', acct: 'xxxx-8841', bankAddress: 'BCA KCP Kaliwungu, Kendal', pkp: false, top: '30 hari', overseas: false, nameZh: '' },
